...
<div id="available-gusli">
        ...
        <ul class="images images1">
          ...
          <li>
            ...
            ${nameGusli} № 1, 12 ${nameStrings},<br />${namePrice}250 + ${nameShipping}
            </h2>
          </li>
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli} № 2, 12 ${nameStrings},<br />${namePrice}250 + ${nameShipping}
            </h2>
          </li>
          <div class="hidden-photos">
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli} № 3, 12 ${nameStrings},<br />${namePrice}250 + ${nameShipping}
            </h2>
          </li>
          <div class="hidden-photos">
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli}/Kantele № 5, 11 ${nameStrings},<br />${namePrice}230 + ${nameShipping}
            </h2>
          </li>
          <div class="hidden-photos">
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli}/Kantele № 6, 11 ${nameStrings},<br />${namePrice}230 + ${nameShipping}
            </h2>
          </li>
          <div class="hidden-photos">
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli} № 4, 12 ${nameStrings},<br />${namePrice}250 + ${nameShipping}
            </h2>
          </li>
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli} № 8, 12 ${nameStrings},<br />${namePrice}250 + ${nameShipping}
            </h2>
          </li>
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli} № 9, 11 ${nameStrings},<br />${namePrice}250 + ${nameShipping}
            </h2>
          </li>
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli} № 10, 12 ${nameStrings},<br />${namePrice}250 + ${nameShipping}
            </h2>
          </li>
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli} № 12, 12 ${nameStrings},<br />${namePrice}250 + ${nameShipping}
            </h2>
          </li>
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli} № 14, 12 ${nameStrings},<br />${namePrice}250 + ${nameShipping}
            </h2>
          </li>
        ...
        <ul class="images images1">
          ...
          <li>
            <h2 class="textproduct">
            ${nameGusli} № 11, 20 ${nameStrings},<br />${namePrice}400 + ${nameShipping}
            </h2>
          </li>
        ...
        <ul class="images images1">
          <li class="visible">
            <img src="../../images/product/15/1.jpg" alt="${nameGusli}-${nameImage}-1" />
          </li>

          <li>
            <h2 class="textproduct">
            ${nameGusli} № 15, 20 ${nameStrings},<br />${namePrice}400 + ${nameShipping}
            </h2>
          </li>

          <div class="hidden-photos">
            <img src="../../images/product/15/2.jpg" alt="${nameGusli}-${nameImage}-2" />
          </div>
        </ul>
...
<ul class="images images1">
  ...
  <li>
    <h2 class="textproduct">
    ${nameLyre} №4, 7 ${nameStrings},<br /> not available 
    </h2>
  </li>
  <div class="hidden-photos">
    <img src="../../images/lira/4/2.jpg" alt="${nameLyre}-${nameImage}-2" />
    <img src="../../images/lira/4/3.jpg" alt="${nameLyre}-${nameImage}-3" />
    <img src="../../images/lira/4/4.jpg" alt="${nameLyre}-${nameImage}-4" />
  </div>
</ul>

<ul class="images images1">
  <li class="visible">
    <img src="../../images/lira/5/1.jpg" alt="${nameLyre}-${nameImage}-1" />
  </li>

  <li>
    <h2 class="textproduct">
    ${nameLyre} №5, 7 ${nameStrings},<br /> not available 
    </h2>
  </li>
  <div class="hidden-photos">
    <img src="../../images/lira/5/2.jpg" alt="${nameLyre}-${nameImage}-2" />
    <img src="../../images/lira/5/3.jpg" alt="${nameLyre}-${nameImage}-3" />
  </div>
</ul>

<ul class="images images1">
  <li class="visible">
    <img src="../../images/lira/6/1.jpg" alt="${nameLyre}-${nameImage}-1" />
  </li>

  <li>
    <h2 class="textproduct">
    ${nameLyre} №6, 7 ${nameStrings},<br /> ${namePrice}300 + ${nameShipping}
    </h2>
  </li>
  <div class="hidden-photos">
    <img src="../../images/lira/6/2.jpg" alt="${nameLyre}-${nameImage}-2" />
    <img src="../../images/lira/6/3.jpg" alt="${nameLyre}-${nameImage}-3" />
    <img src="../../images/lira/6/4.jpg" alt="${nameLyre}-${nameImage}-4" />
  </div>
</ul>

<ul class="images images1">
  <li class="visible">
    <img src="../../images/lira/7/1.jpg" alt="Trossingen lyre-${nameImage}-1" />
  </li>

  <li>
    <h2 class="textproduct">
    Trossingen lyre, 6 ${nameStrings},<br /> ${namePrice}300 + ${nameShipping}
    </h2>
  </li>
  <div class="hidden-photos">
    <img src="../../images/lira/7/2.jpg" alt="${nameLyre}-${nameImage}-2" />
    <img src="../../images/lira/7/3.jpg" alt="${nameLyre}-${nameImage}-3" />
  </div>
</ul>

<ul class="images images1">
  <li class="visible">
    <img src="../../images/lira/8/1.jpg" alt="${nameLyre}-${nameImage}-1" />
  </li>

  <li>
    <h2 class="textproduct">
    ${nameLyre} №8, 7 ${nameStrings},<br /> ${namePrice}300 + ${nameShipping}
    </h2>
  </li>
  <div class="hidden-photos">
    <img src="../../images/lira/8/2.jpg" alt="${nameLyre}-${nameImage}-2" />
    <img src="../../images/lira/8/3.jpg" alt="${nameLyre}-${nameImage}-3" />
    <img src="../../images/lira/8/4.jpg" alt="${nameLyre}-${nameImage}-4" />
    <img src="../../images/lira/8/5.jpg" alt="${nameLyre}-${nameImage}-4" />
  </div>
</ul>

<ul class="images images1">
  <li class="visible">
    <img src="../../images/lira/9/1.jpg" alt="${nameLyre}-${nameImage}-1" />
  </li>

  <li>
    <h2 class="textproduct">
    ${nameLyre} №9, 7 ${nameStrings},<br /> not available
    </h2>
  </li>
  <div class="hidden-photos">
    <img src="../../images/lira/9/2.jpg" alt="${nameLyre}-${nameImage}-2" />
    <img src="../../images/lira/9/3.jpg" alt="${nameLyre}-${nameImage}-3" />
  </div>
</ul>

<ul class="images images1">
  <li class="visible">
    <img src="../../images/lira/10/1.jpg" alt="${nameLyre}-${nameImage}-1" />
  </li>

  <li>
    <h2 class="textproduct">
    ${nameLyre} №10, 7 ${nameStrings},<br /> ${namePrice}300 + ${nameShipping}
    </h2>
  </li>
  <div class="hidden-photos">
    <img src="../../images/lira/10/2.jpg" alt="${nameLyre}-${nameImage}-2" />
    <img src="../../images/lira/10/3.jpg" alt="${nameLyre}-${nameImage}-3" />
    <img src="../../images/lira/10/4.jpg" alt="${nameLyre}-${nameImage}-4" />
  </div>
</ul>

<ul class="images images1">
  <li class="visible">
    <img src="../../images/lira/11/1.jpg" alt="${nameLyre}-${nameImage}-1" />
  </li>

  <li>
    <h2 class="textproduct">
    ${nameLyre} №11, 7 ${nameStrings},<br /> ${namePrice}300 + ${nameShipping}
    </h2>
  </li>
  <div class="hidden-photos">
    <img src="../../images/lira/11/2.jpg" alt="${nameLyre}-${nameImage}-2" />
    <img src="../../images/lira/11/3.jpg" alt="${nameLyre}-${nameImage}-3" />
  </div>
</ul>
...
<div class="footer-date">Copyright © 2025</div>
`
);
